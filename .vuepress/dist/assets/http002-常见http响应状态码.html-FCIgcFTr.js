import{_ as n,o as i,c as e,d}from"./app-1IAv0yAY.js";const l={},s=d(`<h1 id="http002-常见http响应状态码" tabindex="-1"><a class="header-anchor" href="#http002-常见http响应状态码" aria-hidden="true">#</a> http002-常见http响应状态码</h1><h2 id="常见总结" tabindex="-1"><a class="header-anchor" href="#常见总结" aria-hidden="true">#</a> 常见总结</h2><blockquote><p>200: 请求被正常处理 204：请求被受理但没有资源可以返回 206：客户端只是请求资源的一部分，服务器只对请求的部分资源执行GET方法，相应报文中通过Content-Range指定范围的资源。 301：永久性重定向 302：临时重定向 303：与302状态码有相似功能，只是它希望客户端在请求一个URI的时候，能通过GET方法重定向到另一个URI上 304：发送附带条件的请求时，条件不满足时返回，与重定向无关 307：临时重定向，与302类似，只是强制要求使用POST方法 400：请求报文语法有误，服务器无法识别 401：请求需要认证 403：请求的对应资源禁止被访问 404：服务器无法找到对应资源 500：服务器内部错误 503：服务器正忙</p></blockquote><h2 id="详情" tabindex="-1"><a class="header-anchor" href="#详情" aria-hidden="true">#</a> 详情</h2><p>参考《RESTful WebServices》 一书</p><h2 id="_1xx-通知" tabindex="-1"><a class="header-anchor" href="#_1xx-通知" aria-hidden="true">#</a> 1XX：通知</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1XX系列响应代码仅在与HTTP服务器沟通时使用。
