import{_ as i,o as n,c as e,e as s,a as d,d as l}from"./app-G0TSq-iO.js";const v={},r=d("p",null,"斐波那契数列，又称黄金分割数列，指的是0 1 1 2 3 5 8 13 21",-1),a=l(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function getFibonacci(n) {
	var fibarr = [];
	var i = 0;
	while(i &lt; n) {
		if(i &lt;= 1) {
