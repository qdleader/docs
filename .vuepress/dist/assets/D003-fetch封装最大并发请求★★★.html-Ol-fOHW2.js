import{_ as n,o as e,c as i,d as s}from"./app-xrgnhFxe.js";const l={},d=s(`<h1 id="d003-fetch封装最大并发请求" tabindex="-1"><a class="header-anchor" href="#d003-fetch封装最大并发请求" aria-hidden="true">#</a> D003-fetch封装最大并发请求</h1><h1 id="★★★" tabindex="-1"><a class="header-anchor" href="#★★★" aria-hidden="true">#</a> ★★★</h1><h2 id="方法1" tabindex="-1"><a class="header-anchor" href="#方法1" aria-hidden="true">#</a> 方法1</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function sendResquest(urls, max, callback) {
