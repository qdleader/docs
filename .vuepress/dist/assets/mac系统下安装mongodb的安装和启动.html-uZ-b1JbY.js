import{_ as n,o,c as d,d as e}from"./app-C59QzqDT.js";const l={},i=e(`<p>1.官网下载地址：www.mongodb.com/try/downloa… 进去之后选择社区版 https://www.mongodb.com/try/download</p><p>下载 MongoDB Community Server 这个版本</p><p>2.将下载好的文件解压缩，重命名为mongodb，</p><p>3.打开访达按 ⬆️+Command+G ，在前往中输入/usr/local， 将重命名的文件放在/usr/local 目录下 4.配置环境变量，打开终端，输入“open -e .bash_profile”： 再打开的文件中输入“export PATH=\${PATH}:/usr/local/mongodb/bin”</p><p>然后输入“source .bash_profile”，使配置立即生效。</p><p>5.输入mongod --version ,看到版本号则说明安装成功。</p><p>6.在/usr/local/mongodb 目录下创建两个文件夹: data 和 log。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir data
