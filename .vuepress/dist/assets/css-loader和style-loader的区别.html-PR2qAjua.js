import{_ as n,o as s,c as a,d as t}from"./app-1IAv0yAY.js";const p={},e=t(`<div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>webpack是用<span class="token constant">JS</span>写的，运行在node环境，所以默认webpack打包的时候只会处理<span class="token constant">JS</span>之间的依赖关系。
