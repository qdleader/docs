import{_ as e,o as n,c as i,d as a}from"./app-FRQgbCNf.js";const d={},s=a(`<h2 id="接口类型" tabindex="-1"><a class="header-anchor" href="#接口类型" aria-hidden="true">#</a> 接口类型</h2><h3 id="可选属性" tabindex="-1"><a class="header-anchor" href="#可选属性" aria-hidden="true">#</a> 可选属性</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>interface IState {
    name: string,
    age?:number  //可有可无
}
