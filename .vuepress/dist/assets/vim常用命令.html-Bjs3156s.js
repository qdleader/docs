import{_ as i,o as n,c as e,d}from"./app-FRQgbCNf.js";const s={},l=d(`<h2 id="_1、插入命令" tabindex="-1"><a class="header-anchor" href="#_1、插入命令" aria-hidden="true">#</a> 1、插入命令</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>         i :在当前位置生前插入
