import{_ as e,o as n,c as s,d as i}from"./app-Ni1_oyYA.js";const t={},l=i(`<p>##S010-实现类似getElementsByClassName的功能</p><p>#实现一个函数，查找某个DOM节点下面的包含某个class的所有DOM节点，不允许使用原生的getElementsByClassName</p><p>querySelectorAll等原生提供DOM查找函数。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function queryClassName(node, name) {
	var starts = &#39;(^|[ \\n\\r\\t\\f])&#39;,
		ends = &#39;([\\n\\r\\t\\f]|$)&#39;;
