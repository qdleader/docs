import{_ as e,o as n,c as i,d as s}from"./app-C59QzqDT.js";const l={},d=s(`<p>TS提供给了我们三个修饰符</p><p>public 共有属性 都可以访问到 protected 保护属性 只有这个类的内部和子类中可以访问到 private 私有属性 只有这个类中可以访问到，子类都访问不到</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>class Parent {
