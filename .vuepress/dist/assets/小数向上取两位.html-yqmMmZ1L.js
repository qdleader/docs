import{_ as e,o as n,c as i,d as l}from"./app-qTEUp92E.js";const s={},r=l(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 向上取两位小数
upFixed (num, fix) {
  // num为原数字，fix是保留的小数位数
  let result = &#39;0&#39;
