import{_ as n,o as s,c as a,d as t}from"./app-pokGQ7aS.js";const p={},e=t(`<div class="language-tsx line-numbers-mode" data-ext="tsx"><pre class="language-tsx"><code>Next<span class="token punctuation">.</span>js 给自己的介绍是“The React Framework”，没接触过的同学可能会有疑问？React 已经是一个框架了，为什么还要有 Next<span class="token punctuation">.</span>js 呢？其实 Next<span class="token punctuation">.</span>js 是为了互补 React 的不足，Next<span class="token punctuation">.</span>js 提供了 <span class="token constant">CSR</span>、<span class="token constant">SSR</span>、<span class="token constant">SSG</span>、<span class="token constant">ISR</span>、 Streaming 这么多渲染方式，
