import{_ as i,o as e,c as n,d as a}from"./app-Ni1_oyYA.js";const d={},s=a(`<h2 id="一、什么是tag" tabindex="-1"><a class="header-anchor" href="#一、什么是tag" aria-hidden="true">#</a> 一、什么是tag</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>tag是git版本库的一个标记，指向某个commit的指针。
