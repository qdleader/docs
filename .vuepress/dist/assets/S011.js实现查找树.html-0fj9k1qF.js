...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>未完待续。。。</p>`,7);function c(a,v){return t(),l("div",null,[e(" 二叉树 "),o,e(` 它还应该有一些方法：
...
findMin() 返回树中的最小值
findMax() 返回树中的最大值
remove(key) 删除树中的某个键 `),r])}const b=i(s,[["render",c],["__file","S011.js实现查找树.html.vue"]]);export{b as default};
