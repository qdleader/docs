import{_ as e,o as i,c as n,d as l}from"./app-FRQgbCNf.js";const d={},s=l(`<p>题目：</p><blockquote><p>2、使用原生js，ul li中的最后一个p标签。 (1) 删除最后一个p标签<br> (2) 点击任意li标签，打印所在序号。（用直接绑定 和 事件委托） 2种方式</p></blockquote><p>答案：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
&lt;ul id=&quot;oBox&quot;&gt;
    &lt;li&gt;
        &lt;p&gt;1&lt;/p&gt;
        &lt;p&gt;2&lt;/p&gt;
