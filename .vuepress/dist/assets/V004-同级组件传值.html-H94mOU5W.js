import{_ as i,o as e,c as n,d as l}from"./app-pokGQ7aS.js";const t={},d=l(`<p>1.如果是兄弟组件，可通过父元素作为中间组件进行传值</p><p>1.2 $emit传值，props接收</p><p>使用$emit将child1.vue的值给父组件，父组件将值传给child2.vue,child2.vue使用props接收</p><p>parent.vue</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;template&gt;
  &lt;div&gt;
     &lt;h2&gt;我是父组件&lt;/h2&gt;
