import{_ as e,o as n,c as i,d}from"./app-Ni1_oyYA.js";const l={},s=d(`<h2 id="addeventlistener-默认是捕获还是冒泡" tabindex="-1"><a class="header-anchor" href="#addeventlistener-默认是捕获还是冒泡" aria-hidden="true">#</a> addEventListener 默认是捕获还是冒泡</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>默认是冒泡
