import{_ as n,o as s,c as a,d as t}from"./app-pokGQ7aS.js";const p={},e=t(`<h2 id="输入中文拼音导致input-重复触发事件" tabindex="-1"><a class="header-anchor" href="#输入中文拼音导致input-重复触发事件" aria-hidden="true">#</a> 输入中文拼音导致input 重复触发事件？</h2><h4 id="web前端之中文输入法导致的高频事件、addeventlistener、compositionstart、compositionend" tabindex="-1"><a class="header-anchor" href="#web前端之中文输入法导致的高频事件、addeventlistener、compositionstart、compositionend" aria-hidden="true">#</a> web前端之中文输入法导致的高频事件、addEventListener、compositionstart、compositionend</h4><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token operator">&lt;</span>input type<span class="token operator">=</span><span class="token string">&quot;text&quot;</span> <span class="token operator">/</span><span class="token operator">&gt;</span>
