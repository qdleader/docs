<<<<<<< HEAD:.vuepress/dist/assets/搭建内网npm.html-PvRSJ9DN.js
import{_ as n,o as s,c as a,a as e}from"./app-9rky8OyZ.js";const i={},l=e(`<h2 id="verdaccio-搭建-npm-私有仓库" tabindex="-1"><a class="header-anchor" href="#verdaccio-搭建-npm-私有仓库" aria-hidden="true">#</a> Verdaccio 搭建 npm 私有仓库</h2><p>为什么要搭建私有仓库？</p><p>日常开发中我们肯定会封装一些通用组件，大部分情况下都会存在于 components 目录下；试想一下如果我们有两个系统 A 和 B，此时这两个系统都要用到的组件我们该如何封装呢？</p><p>这种情况下我们还是开发一个包托管到 npm 比较靠谱，随用随下载。但是这些组件有一定的隐私性，我们又不想让别人看到。此时 Verdaccio 的好处就体现出来了。</p><p>Verdaccio 是一个 Node.js 创建的轻量级 npm 仓库（就是一个应用支持独立部署安装）。可以快速帮助我们搭建一个类似于 npm 的网页应用程序用于托管我们的包</p><p>前置条件 本文介绍 Verdaccio 为 5.x 版本；示例演示系统为 阿里云 CentOS。由于此软件是基于 Node.js 开发，需要现在服务器安装 Node.js 并确保版本为 12.x。</p><p>提示：推荐使用 nvm 管理 node 版本；安装 nvm</p><p>安装 Verdaccio</p><h1 id="必须要加-g-全局安装" tabindex="-1"><a class="header-anchor" href="#必须要加-g-全局安装" aria-hidden="true">#</a> 必须要加 -g 全局安装</h1><p>npm install verdaccio -g 安装成功之后随即在命令行输出 \`\` verdaccio</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">[</span>root@hecs<span class="token operator">-</span><span class="token number">3429401</span> <span class="token operator">~</span><span class="token punctuation">]</span># verdaccio
=======
import{_ as n,o as s,c as a,a as e}from"./app-EwkMEanJ.js";const i={},l=e(`<h2 id="verdaccio-搭建-npm-私有仓库" tabindex="-1"><a class="header-anchor" href="#verdaccio-搭建-npm-私有仓库" aria-hidden="true">#</a> Verdaccio 搭建 npm 私有仓库</h2><p>为什么要搭建私有仓库？</p><p>日常开发中我们肯定会封装一些通用组件，大部分情况下都会存在于 components 目录下；试想一下如果我们有两个系统 A 和 B，此时这两个系统都要用到的组件我们该如何封装呢？</p><p>这种情况下我们还是开发一个包托管到 npm 比较靠谱，随用随下载。但是这些组件有一定的隐私性，我们又不想让别人看到。此时 Verdaccio 的好处就体现出来了。</p><p>Verdaccio 是一个 Node.js 创建的轻量级 npm 仓库（就是一个应用支持独立部署安装）。可以快速帮助我们搭建一个类似于 npm 的网页应用程序用于托管我们的包</p><p>前置条件 本文介绍 Verdaccio 为 5.x 版本；示例演示系统为 阿里云 CentOS。由于此软件是基于 Node.js 开发，需要现在服务器安装 Node.js 并确保版本为 12.x。</p><p>提示：推荐使用 nvm 管理 node 版本；安装 nvm</p><p>安装 Verdaccio</p><h1 id="必须要加-g-全局安装" tabindex="-1"><a class="header-anchor" href="#必须要加-g-全局安装" aria-hidden="true">#</a> 必须要加 -g 全局安装</h1><p>npm install verdaccio -g 安装成功之后随即在命令行输出 \`\` verdaccio</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token punctuation">[</span>root@hecs<span class="token operator">-</span><span class="token number">3429401</span> <span class="token operator">~</span><span class="token punctuation">]</span># verdaccio
>>>>>>> bcdf61aa103e3d08c2a5829963b9e02491bcea3f:.vuepress/dist/assets/搭建内网npm.html-veCrHql8.js
 ...
 info <span class="token operator">--</span><span class="token operator">-</span> plugin successfully loaded<span class="token operator">:</span> verdaccio<span class="token operator">-</span>htpasswd
 info <span class="token operator">--</span><span class="token operator">-</span> plugin successfully loaded<span class="token operator">:</span> verdaccio<span class="token operator">-</span>audit
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),c=[l];function t(o,p){return s(),a("div",null,c)}const d=n(i,[["render",t],["__file","搭建内网npm.html.vue"]]);export{d as default};
