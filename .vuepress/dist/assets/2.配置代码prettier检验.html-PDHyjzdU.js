import{_ as n,o as s,c as a,d as t}from"./app-FRQgbCNf.js";const e={},p=t(`<p>记得我们在git中有个命令是 npm run link吗 走的就是packjson 中的这个</p><p>在packjson 中增加</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>  &quot;scripts<span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
