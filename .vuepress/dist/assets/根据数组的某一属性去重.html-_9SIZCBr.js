import{_ as e,o as n,c as i,d as a}from"./app-FRQgbCNf.js";const r={},d=a(`<h2 id="方法1" tabindex="-1"><a class="header-anchor" href="#方法1" aria-hidden="true">#</a> 方法1：</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>unique(arr) {
  const res = new Map();
