import{_ as e,o as i,c as n,d as a}from"./app-tgHnmF2J.js";const r={},l=a(`<h1 id="求数组的最大最小值。" tabindex="-1"><a class="header-anchor" href="#求数组的最大最小值。" aria-hidden="true">#</a> 求数组的最大最小值。</h1><p>let arr = [12,125,732,102,345,75,23,4,234]</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Math.max.apply(null,arr)
