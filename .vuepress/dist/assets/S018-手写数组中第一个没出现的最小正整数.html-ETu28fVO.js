import{_ as n,o as i,c as e,d as s}from"./app-tgHnmF2J.js";const l={},d=s(`<p>手写-如何找到数组中第一个没出现的最小正整数 怎么优化</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>给你一个未排序的整数数组 nums ，请你找出其中没有出现的最小的正整数。
