import{_ as e,o as n,c as i,d}from"./app-gxPsN6Nl.js";const s={},l=d(`<h1 id="将秒数转化为时分秒的时间格式" tabindex="-1"><a class="header-anchor" href="#将秒数转化为时分秒的时间格式" aria-hidden="true">#</a> 将秒数转化为时分秒的时间格式</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>export const formatSeconds = (date) =&gt; {
