import{_ as e,o as i,c as n,d as s}from"./app-C59QzqDT.js";const d={},a=s(`<h2 id="下面输出结果" tabindex="-1"><a class="header-anchor" href="#下面输出结果" aria-hidden="true">#</a> 下面输出结果</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>console.log(100)
setTimeout(() =&gt; {
  console.log(200)
})
