import{_ as e,o as i,c as n,d as s}from"./app-C59QzqDT.js";const l={},d=s(`<h1 id="实现一个元素水平垂直居中的方法★★★★" tabindex="-1"><a class="header-anchor" href="#实现一个元素水平垂直居中的方法★★★★" aria-hidden="true">#</a> 实现一个元素水平垂直居中的方法★★★★</h1><h1 id="重要程度★★★★" tabindex="-1"><a class="header-anchor" href="#重要程度★★★★" aria-hidden="true">#</a> 重要程度★★★★</h1><p>1.absolute + 负margin</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.parent {
	position:relative;
}
.son {
	position:absolute;
