import{_ as i,o as n,c as e,d as l}from"./app-1IAv0yAY.js";const s={},d=l(`<p>vue 3 diif 用的就是单调递增子序列</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    var lengthOfLIS = function (nums) {
      let n = nums.length;
      if (n &lt;= 1) {
        return n;
      }
