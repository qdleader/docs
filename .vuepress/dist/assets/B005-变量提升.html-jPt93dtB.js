import{_ as e,o as n,c as i,d as a}from"./app-1IAv0yAY.js";const d={},r=a(`<h1 id="下面结果输出什么" tabindex="-1"><a class="header-anchor" href="#下面结果输出什么" aria-hidden="true">#</a> 下面结果输出什么？</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>var b =1;
function outer() {
	var b = 2
	function inner() {
		b++;
