import{_ as n,o as s,c as a,d as t}from"./app-gxPsN6Nl.js";const p={},e=t(`<h1 id="h5吊起支付宝app支付-前端实现" tabindex="-1"><a class="header-anchor" href="#h5吊起支付宝app支付-前端实现" aria-hidden="true">#</a> h5吊起支付宝app支付 （前端实现）</h1><p>后端按照支付宝官网会返回一个form表单</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 支付宝H5支付</span>
