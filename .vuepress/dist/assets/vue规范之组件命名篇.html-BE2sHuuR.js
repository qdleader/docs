import{_ as e,o as n,c as i,d as a}from"./app-gxPsN6Nl.js";const d={},s=a(`<h2 id="_1-单文件组件文件的大小写" tabindex="-1"><a class="header-anchor" href="#_1-单文件组件文件的大小写" aria-hidden="true">#</a> 1.单文件组件文件的大小写</h2><blockquote><p>单文件组件的文件名应该要么始终是单词大写开头 (PascalCase)，要么始终是横线连接 (kebab-case)。我们推荐大写开头</p></blockquote><h3 id="bad" tabindex="-1"><a class="header-anchor" href="#bad" aria-hidden="true">#</a> bad:</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>components/
|-mycomponent.vue 
