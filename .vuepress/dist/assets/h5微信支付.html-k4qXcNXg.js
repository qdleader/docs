import{_ as n,o as s,c as a,d as e}from"./app-FRQgbCNf.js";const t={},p=e(`<h1 id="h5微信支付" tabindex="-1"><a class="header-anchor" href="#h5微信支付" aria-hidden="true">#</a> h5微信支付</h1><p>微信内支付用sdk，这在微信公众开发的文章已详细提到。 我们在这说一下，微信外浏览器微信支付。</p><p>我们在这先判断是微信内浏览器还是微信外浏览器。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 判断是否公众号（微信H5）</span>
