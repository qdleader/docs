import{_ as e,o as n,c as l,d as s}from"./app-G0TSq-iO.js";const o={},i=s(`<h1 id="定义一个log方法-可以取代console" tabindex="-1"><a class="header-anchor" href="#定义一个log方法-可以取代console" aria-hidden="true">#</a> 定义一个log方法，可以取代console</h1><p>1.乞丐版</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function log(msg) {
  console.log(msg)
}
