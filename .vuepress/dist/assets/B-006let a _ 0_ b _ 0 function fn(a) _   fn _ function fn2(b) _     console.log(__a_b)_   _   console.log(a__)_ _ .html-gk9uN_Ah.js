import{_ as e,o as n,c as a,d as i}from"./app-Ni1_oyYA.js";const _={},l=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>let a = 0, b = 0
function fn(a) {
  fn = function fn2(b) {
    console.log(++a+b);
  }
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>&#39;+&#39; 在后面 后加</p><p>&#39;+&#39; 在前面 先加</p></blockquote>`,13),s=[l];function d(c,o){return n(),a("div",null,s)}const t=e(_,[["render",d],["__file","B-006let a _ 0_ b _ 0 function fn(a) _   fn _ function fn2(b) _     console.log(__a_b)_   _   console.log(a__)_ _ .html.vue"]]);export{t as default};
