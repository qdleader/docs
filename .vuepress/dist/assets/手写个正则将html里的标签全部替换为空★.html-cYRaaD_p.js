import{_ as e,o as a,c as t,d}from"./app-FRQgbCNf.js";const n={},i=d(`<h1 id="手写个正则将html里的标签全部替换为空★" tabindex="-1"><a class="header-anchor" href="#手写个正则将html里的标签全部替换为空★" aria-hidden="true">#</a> 手写个正则将html里的标签全部替换为空★</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>str.replace(/(&lt;(.[^&gt;]*)&gt;)|(&amp;nbsp;)/g,&quot;&quot;) 
