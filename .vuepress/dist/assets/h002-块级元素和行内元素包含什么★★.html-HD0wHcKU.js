import{_ as i,o as n,c as e,d as l}from"./app-pokGQ7aS.js";const d={},s=l(`<h1 id="h002-块级元素和行内元素包含什么★★" tabindex="-1"><a class="header-anchor" href="#h002-块级元素和行内元素包含什么★★" aria-hidden="true">#</a> h002-块级元素和行内元素包含什么★★</h1><h2 id="块级元素" tabindex="-1"><a class="header-anchor" href="#块级元素" aria-hidden="true">#</a> 块级元素</h2><blockquote><p>1 独占一行 2.可以设置宽高，如果不设置默认为父集宽的的100%</p></blockquote><p>包括：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>div
