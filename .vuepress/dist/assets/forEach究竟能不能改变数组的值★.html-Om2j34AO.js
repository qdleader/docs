import{_ as e,o as n,c as l,d as i}from"./app-otDwoQZb.js";const d={},r=i(`<h1 id="foreach究竟能不能改变数组的值★" tabindex="-1"><a class="header-anchor" href="#foreach究竟能不能改变数组的值★" aria-hidden="true">#</a> forEach究竟能不能改变数组的值★</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    let obj = {&#39;1&#39;:1}
