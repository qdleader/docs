import{_ as a,o as n,c as s,d as e}from"./app-C59QzqDT.js";const p={},t=e(`<p>Nginx 默认什么都不配置的时候，是开启协商缓存的</p><p>若想要关掉协商缓存</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code>location <span class="token operator">/</span> <span class="token punctuation">{</span>
