import{_ as n,o as i,c as e,d}from"./app-tgHnmF2J.js";const u={},s=d(`<h1 id="b-002经典闭包★★" tabindex="-1"><a class="header-anchor" href="#b-002经典闭包★★" aria-hidden="true">#</a> B-002经典闭包★★</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function fun(n,o) {
  console.log(o)
  return {
    fun: function(m) {
      return fun(m,n)
