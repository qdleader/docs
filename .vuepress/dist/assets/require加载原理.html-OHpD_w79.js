import{_ as e,o as n,c as i,d as s}from"./app-qTEUp92E.js";const d={},r=s(`<h2 id="require-模块引入与处理" tabindex="-1"><a class="header-anchor" href="#require-模块引入与处理" aria-hidden="true">#</a> require 模块引入与处理</h2><blockquote><p>CommonJS 模块同步加载并执行模块文件，CommonJS 模块在执行阶段分析模块依赖，采用深度优先遍历（depth-first traversal），执行顺序是父 -&gt; 子 -&gt; 父；</p></blockquote><p>eg:</p><p>a.js文件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const getMes = require(&#39;./b&#39;)
console.log(&#39;我是 a 文件&#39;)
