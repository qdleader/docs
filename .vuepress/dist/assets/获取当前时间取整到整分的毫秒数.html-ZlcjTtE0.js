import{_ as n,o as s,c as a,d as e}from"./app-Ni1_oyYA.js";const t={},c=e(`<h1 id="获取当前时间取整到整分的毫秒数" tabindex="-1"><a class="header-anchor" href="#获取当前时间取整到整分的毫秒数" aria-hidden="true">#</a> 获取当前时间取整到整分的毫秒数</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>getCurrent() {
	let now = new Date();
