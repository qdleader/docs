import{_ as e,r as t,o as l,c as s,a as i,b as r,f as d,d as a}from"./app-tSvYcIf0.js";const v={},c=a(`<p>#003- 快速排序</p><p>快排核心思想是 ：</p><p>选定一个基准x，将比x小的值放到左边，比x大的值放到右边。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const partition = (arr, left, right) =&gt; {
	let x = arr[left];
	let i = left;
	let j = right;
