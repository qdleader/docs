import{_ as n,o as s,c as a,d as e}from"./app-tSvYcIf0.js";const p={},t=e(`<h1 id="tree-shaking-的原理是什么" tabindex="-1"><a class="header-anchor" href="#tree-shaking-的原理是什么" aria-hidden="true">#</a> Tree Shaking 的原理是什么</h1><p>Tree Shaking 指基于 ES Module 进行静态分析，通过 AST 将用不到的函数进行移除，从而减小打包体积。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/* TREE-SHAKING */</span>
