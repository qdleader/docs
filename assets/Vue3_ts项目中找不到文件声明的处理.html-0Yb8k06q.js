import{_ as n,o as s,c as e,d as a}from"./app-tSvYcIf0.js";const t={},o=a(`<p>.d.ts文件放置的目录与tsconfig.json文件指定的includes匹配列表路径一致</p><p>我的是放到src 下面 新建一个 vite-env.d.ts文件</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">/// &lt;reference types=&quot;vite/client&quot; /&gt;</span>
