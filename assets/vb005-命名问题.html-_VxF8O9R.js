import{_ as e,o as n,c as i,d}from"./app-tSvYcIf0.js";const s={},l=d(`<p>#1.单文件组件的命名</p><p>以大写开头的驼峰命名，或者全部小写中间已中划线分割。</p><p>bad</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>myComponent.vue
