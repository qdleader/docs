import{_ as e,o as i,c as s,a,t as l,d as n}from"./app-tSvYcIf0.js";const d={},v=n(`<h2 id="map-的使用" tabindex="-1"><a class="header-anchor" href="#map-的使用" aria-hidden="true">#</a> map 的使用</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>map.set(key,value)添加键值对到映射中
