import{_ as e,o as n,c as i,d as l}from"./app-tSvYcIf0.js";const u={},s=l(`<p>Javascript 隐式强制类型转换</p><p>这里直接上各种类型之间的转换结果，如果没有明白，那就带着问题往下读。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>❞
+、==、||、&amp;&amp;
+ (重点)
1 + &quot;1&quot; // &#39;11&#39;
